...
export const selectionSort = async (arr: ArrayElement[], direction: Direction, set: Dispatch<React.SetStateAction<ArrayElement[]>>) => {
...
export const bubbleSort = async (arr: ArrayElement[], direction: Direction, set: Dispatch<React.SetStateAction<ArrayElement[]>>) => {
